               ...
               {{-- ($anesthesiaunit->id ==1) OR --}}
                  ...
                  @else       
                    ...
                    <tr>
                        ...
                        @if(($anesthesiaunit->RangeCC) <=($anesthesiaunits[0]->RangeCC)  )
                        ...
                        @if(($anesthesiaunit->CC) <=($anesthesiaunits[0]->CC)  )
                        ...
                        @if(($anesthesiaunit->RangeLm) <=($anesthesiaunits[0]->RangeLm)  )
                        ...
                        @if(($anesthesiaunit->bpmH) <=($anesthesiaunits[0]->bpmH)  )
                        ...
                        @if(($anesthesiaunit->bpmL) <=($anesthesiaunits[0]->bpmL)  )
                        ...
                        @if(($anesthesiaunit->InspiratoryFlowH) <=($anesthesiaunits[0]->InspiratoryFlowH)  )
                        ...
                        @if(($anesthesiaunit->InspiratoryFlowL) <=($anesthesiaunits[0]->InspiratoryFlowL)  )
                        ...
                        @if(($anesthesiaunit->InspiratoryPause) >=($anesthesiaunits[0]->InspiratoryPause)  )
                        ...
                        @if(($anesthesiaunit->Pressurelimit) <=($anesthesiaunits[0]->Pressurelimit)  )
                        ...
                        @if(($anesthesiaunit->PEEP) <=($anesthesiaunits[0]->PEEP)  )
                      ...
                      {{-- DISPLAYS --}}
                        @if(($anesthesiaunit->Number) <=($anesthesiaunits[0]->Number)  )
                      ...
                      <td>{{$anesthesiaunit->UserInterface}}</td>
                        ...
                        @if(($anesthesiaunit->PrioritizedAlarms) <=($anesthesiaunits[0]->PrioritizedAlarms)  )
                      ...
                      <td>{{$anesthesiaunit->AuxiliaryOutlets}}</td>
                        ...
                        @if(($anesthesiaunit->UsePerCharge) >=($anesthesiaunits[0]->UsePerCharge)  )
