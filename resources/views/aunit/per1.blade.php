               ...
               {{-- ($anesthesiaunit->id ==1) OR --}}
                  ...
                  @else       
                    ...
                    <tr>
                        ...
                        @if(((($anesthesiaunit->FDAClearance) !=NULL) AND (($anesthesiaunit->FDAClearance) !='NO') ) OR (($anesthesiaunits[1]->FDAClearance) ==NULL ) )
                        ...
                        @if(((($anesthesiaunit->PipelineGasInletsO2) !=NULL) AND (($anesthesiaunit->PipelineGasInletsO2) !='NO') ) OR (($anesthesiaunits[1]->PipelineGasInletsO2) ==NULL ) )
                        ...
                        @if(((($anesthesiaunit->PipelineGasInletsN2O) !=NULL) AND (($anesthesiaunit->PipelineGasInletsN2O) !='NO') ) OR (($anesthesiaunits[1]->PipelineGasInletsN2O) ==NULL ) )
                        ...
                        @if(((($anesthesiaunit->PipelineGasInletsAir) !=NULL) AND (($anesthesiaunit->PipelineGasInletsAir) !='NO') ) OR (($anesthesiaunits[1]->PipelineGasInletsAir) ==NULL ) )
                        ...
                        @if(((($anesthesiaunit->GasCylinderYokesO2) !=NULL) AND (($anesthesiaunit->GasCylinderYokesO2) !='NO') ) OR (($anesthesiaunits[1]->GasCylinderYokesO2) ==NULL ) )
                        ...
                        @if(((($anesthesiaunit->GasCylinderYokesN2O) !=NULL) AND (($anesthesiaunit->GasCylinderYokesN2O) !='NO') ) OR (($anesthesiaunits[1]->GasCylinderYokesN2O) ==NULL ) )
                        ...
                        @if(((($anesthesiaunit->GasCylinderYokesAir) !=NULL) AND (($anesthesiaunit->GasCylinderYokesAir) !='NO') ) OR (($anesthesiaunits[1]->GasCylinderYokesAir) ==NULL ) )
                        ...
                        @if(((($anesthesiaunit->VaporizersDesflurane) !=NULL) AND (($anesthesiaunit->VaporizersDesflurane) !='NO') ) OR (($anesthesiaunits[1]->VaporizersDesflurane) ==NULL ) )
                        ...
                        @if(((($anesthesiaunit->VaporizersEnflurane) !=NULL) AND (($anesthesiaunit->VaporizersEnflurane) !='NO') ) OR (($anesthesiaunits[1]->VaporizersEnflurane) ==NULL ) )
                        ...
                        @if(((($anesthesiaunit->VaporizersHalothane) !=NULL) AND (($anesthesiaunit->VaporizersHalothane) !='NO') ) OR (($anesthesiaunits[1]->VaporizersHalothane) ==NULL ) )
                        ...
                        @if(((($anesthesiaunit->VaporizersIsoflurane) !=NULL) AND (($anesthesiaunit->VaporizersIsoflurane) !='NO') ) OR (($anesthesiaunits[1]->VaporizersIsoflurane) ==NULL ) )
                        ...
                        @if(((($anesthesiaunit->VaporizersSevoflurane) !=NULL) AND (($anesthesiaunit->VaporizersSevoflurane) !='NO') ) OR (($anesthesiaunits[1]->VaporizersSevoflurane) ==NULL ) )
                        ...
                        @if(((($anesthesiaunit->ElectronicallyControlled) !=NULL) AND (($anesthesiaunit->ElectronicallyControlled) !='NO') ) OR (($anesthesiaunits[1]->ElectronicallyControlled) ==NULL ) )
                        ...
                        @if(((($anesthesiaunit->Interlock) !=NULL) AND (($anesthesiaunit->Interlock) !='NO') ) OR (($anesthesiaunits[1]->Interlock) ==NULL ) )
                        ...
                        @if(((($anesthesiaunit->O2FailSafe) !=NULL) AND (($anesthesiaunit->O2FailSafe) !='NO') ) OR (($anesthesiaunits[1]->O2FailSafe) ==NULL ) )
                        ...
                        @if(((($anesthesiaunit->HypoxicMixtureFailSafe) !=NULL) AND (($anesthesiaunit->HypoxicMixtureFailSafe) !='NO') ) OR (($anesthesiaunits[1]->HypoxicMixtureFailSafe) ==NULL ) )
                        ...
                        @if(((($anesthesiaunit->AutomaticVentilator) !=NULL) AND (($anesthesiaunit->AutomaticVentilator) !='NO') ) OR (($anesthesiaunits[1]->AutomaticVentilator) ==NULL ) )
                        ...
                        @if(((($anesthesiaunit->VM_Manual_spontaneous) !=NULL) AND (($anesthesiaunit->VM_Manual_spontaneous) !='NO') ) OR (($anesthesiaunits[1]->VM_Manual_spontaneous) ==NULL ) )
                        ...
                        @if(((($anesthesiaunit->VM_VCV) !=NULL) AND (($anesthesiaunit->VM_VCV) !='NO') ) OR (($anesthesiaunits[1]->VM_VCV) ==NULL ) )
                        ...
                        @if(((($anesthesiaunit->VM_SIMV) !=NULL) AND (($anesthesiaunit->VM_SIMV) !='NO') ) OR (($anesthesiaunits[1]->VM_SIMV) ==NULL ) )
                        ...
                        @if(((($anesthesiaunit->VM_AdvancedModes) !=NULL) AND (($anesthesiaunit->VM_AdvancedModes) !='NO') ) OR (($anesthesiaunits[1]->VM_AdvancedModes) ==NULL ) )
                        ...
                        @if(((($anesthesiaunit->RangeCC) <=($anesthesiaunits[1]->RangeCC))) OR ($anesthesiaunits[1]->RangeCC==0)  )
                        ...
                        @if((($anesthesiaunit->CC) <=($anesthesiaunits[1]->CC))  OR ($anesthesiaunits[1]->CC==0) )
                        ...
                        @if((($anesthesiaunit->RangeLm) <=($anesthesiaunits[1]->RangeLm)) OR ($anesthesiaunits[1]->CC==0)  )
                        ...
                        @if((($anesthesiaunit->bpmH) <=($anesthesiaunits[1]->bpmH)) OR ($anesthesiaunits[1]->CC==0)  )
                        ...
                        @if((($anesthesiaunit->bpmL) <=($anesthesiaunits[1]->bpmL)) OR ($anesthesiaunits[1]->CC==0) )
                        ...
                        @if((($anesthesiaunit->InspiratoryFlowH) <=($anesthesiaunits[1]->InspiratoryFlowH)) OR ($anesthesiaunits[1]->CC==0)  )
                        ...
                        @if((($anesthesiaunit->InspiratoryFlowL) <=($anesthesiaunits[1]->InspiratoryFlowL)) OR ($anesthesiaunits[1]->CC==0) )
                        ...
                        @if((($anesthesiaunit->InspiratoryPause) >=($anesthesiaunits[1]->InspiratoryPause)) OR ($anesthesiaunits[1]->CC==0) )
                        ...
                        @if((($anesthesiaunit->Pressurelimit) <=($anesthesiaunits[1]->Pressurelimit) )OR ($anesthesiaunits[1]->CC==0) )
                        ...
                        @if((($anesthesiaunit->PEEP) <=($anesthesiaunits[1]->PEEP))  OR ($anesthesiaunits[1]->CC==0))
                        ...
                        @if(((($anesthesiaunit->SystemChecks) !=NULL) AND (($anesthesiaunit->SystemChecks) !='NO') ) OR (($anesthesiaunits[1]->SystemChecks) ==NULL ) )
                        ...
                        @if(((($anesthesiaunit->ScavengingSystem) !=NULL) AND (($anesthesiaunit->ScavengingSystem) !='NO') ) OR (($anesthesiaunits[1]->ScavengingSystem) ==NULL ) )
                      ...
                      {{-- DISPLAYS --}}
                        @if((($anesthesiaunit->Number) >=($anesthesiaunits[1]->Number) )OR ($anesthesiaunits[1]->CC==0) )
                      ...
                      <td>{{$anesthesiaunit->TypeD}}</td>
                        ...
                        @if(((($anesthesiaunit->IntegratedPM) !=NULL) AND (($anesthesiaunit->IntegratedPM) !='NO') ) OR (($anesthesiaunits[1]->AgentConcentration) ==NULL ) )
                        ...
                        @if(((($anesthesiaunit->InterfacePM) !=NULL) AND (($anesthesiaunit->InterfacePM) !='NO') ) OR (($anesthesiaunits[1]->InterfacePM) ==NULL ) )
                      ...
                      <td>{{$anesthesiaunit->UserInterface}}</td>
                        ...
                        @if((($anesthesiaunit->PrioritizedAlarms) <=($anesthesiaunits[1]->PrioritizedAlarms)) OR ($anesthesiaunits[1]->CC==0) )
                      ...
                      <td>{{$anesthesiaunit->AuxiliaryOutlets}}</td>
                        ...
                        @if(((($anesthesiaunit->BackupBattery) !=NULL) AND (($anesthesiaunit->BackupBattery) !='NO') ) OR (($anesthesiaunits[1]->BackupBattery) ==NULL ) )
                        ...
                        @if((($anesthesiaunit->UsePerCharge) >=($anesthesiaunits[1]->UsePerCharge) )OR ($anesthesiaunits[1]->CC==0) )
      ...
      <div class="container">
        ...
        <table border="1" class="table table-hover table-ligth  table-bordered">
          ...
          @for ($i =0; $i <=2; $i++)
            ...
            <tr>
              <td>{{$anesthesiaunits[$key_of_max-1]->Manufacturer}}</td>
              <td>{{$anesthesiaunits[$key_of_max-1]->WhereMarketed}}</td>
              <td>{{$anesthesiaunits[$key_of_max-1]->Configuration}}</td>
              <td>{{max($scoreList)}}</td>
            </tr>
            <?php
