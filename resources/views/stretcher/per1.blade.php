...
@section('content')
  ...
  justify-content: center;
      ...
      <div class="container" >
        <br />
          <br />
        <h1 align="center">Stretcher Mobile vs Personalized 1</h1>
          <br><br>
                   ...
                   @foreach ($stretchers as $stretcher)
                        ...
                        @else       
                            ...
                            <tr>
                               ...
                               @if((($stretcher->StretcherType) !=NULL ) OR (($stretchers[1]->StretcherType) ==NULL ) )
                               ...
                               @if(((($stretcher->PositionControl) !=NULL) AND (($stretcher->PositionControl) !='NO') ) OR (($stretchers[1]->PositionControl) ==NULL ) )
                               ...
                               @if(((($stretcher->LegLift) !=NULL) AND (($stretcher->LegLift) !='NO') ) OR (($stretchers[1]->LegLift) ==NULL ) )
                               ...
                               @if(((($stretcher->KneeFlex) !=NULL) AND (($stretcher->KneeFlex) !='NO') ) OR (($stretchers[1]->KneeFlex) ==NULL ) )
                               ...
                               @if(((($stretcher->Siderails) !=NULL) AND (($stretcher->Siderails) !='NO') ) OR (($stretchers[1]->Siderails) ==NULL ) )
                               ...
                               @if(((($stretcher->RadiolucentTop) !=NULL) AND (($stretcher->RadiolucentTop) !='NO') ) OR (($stretchers[1]->RadiolucentTop) ==NULL ) )
                               ...
                               @if(((($stretcher->OxygenTankHolder) !=NULL) AND (($stretcher->OxygenTankHolder) !='NO') ) OR (($stretchers[1]->OxygenTankHolder) ==NULL ) )
                                ...
                                @if(((($stretcher->UtilityShelf) !=NULL) AND (($stretcher->UtilityShelf) !='NO') ) OR (($stretchers[1]->UtilityShelf) ==NULL ) )
                               ...
                               @if(((($stretcher->RestrainingStraps) !=NULL) AND (($stretcher->RestrainingStraps) !='NO') ) OR (($stretchers[1]->RestrainingStraps) ==NULL ) )
                               ...
                               @if(((($stretcher->Bumpers) !=NULL) AND (($stretcher->Bumpers) !='NO') ) OR (($stretchers[1]->Bumpers) ==NULL ) )
